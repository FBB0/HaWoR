...
class DepthVideo:
    def __init__(self, image_size=[480, 640], buffer=1024, stereo=False, device=None):
        ...
        self.masks = torch.zeros(buffer, ht//8, wd//8, device=device, dtype=torch.float).share_memory_()
        self.stereo = stereo
